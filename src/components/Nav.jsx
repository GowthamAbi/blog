...
export default function Nav() {
  ...
  return (
   ...
   <nav className='flex justify-between items-center py-5 mx-8 sm:mx-20 xl:mx-32 '>
    ...
    <button onClick={()=>{navigate('/adminlogin')}} className='flex items-center text-white px-4 py-2 gap-2 
    rounded-full text-dm cursor-pointer bg-primary sm:mx-20 xl:mx-32' >{token?'Dashboard':'Login'}
