...
export const Sidebar = () => {
  return (
    <div className='flex flex-col border-r  border-gray-300 sm:w-24 lg:w-48 pt-6 h-250'>
     <NavLink end={true}  to='/admin/dashboard' className={({isActive})=>`flex items-center gap-3 py-3.5 px-4
       cursor-pointer md:px-8  ${isActive && "bg-primary/10 border-r-4 border-primary"} `}>
      <img src={assets.home_icon} className=' min-w-4 w-5'/>
      <h5 className='hidden lg:inline-block'>Dashboard</h5>
     </NavLink>
     ...
     <NavLink to='/admin/addblogs' className={({isActive})=>`flex items-center gap-3 py-3.5 px-4
      ...
      <h5 className='hidden lg:inline-block'>Add Blogs</h5>
     </NavLink>
     ...
     md:px-8 ${isActive&&'bg-primary/10 border-r-4 border-primary'} `}>
      ...
      <h5 className='hidden lg:inline-block'>BlogList</h5>
     </NavLink>

      <NavLink to='/admin/comments' className={({isActive})=>`flex items-center gap-3 py-3.5 px-4 
      md:px-8 ${isActive&&'bg-primary/10 border-r-4 border-primary'} `}>
      <img src={assets.list_icon} className=' min-w-4 w-5'/>
      <h5 className='hidden lg:inline-block'>Comments</h5>
     </NavLink>

     <NavLink to="/admin/addblogss"className={({isActive})=>`flex items-center gap-3 py-3.5 px-4 
      md:px-8 ${isActive&&'bg-primary/10 border-r-4 border-primary'} `}>
        <h5 className=' lg:inline-block'>Add Blogs</h5>
     </NavLink>

     <NavLink to="/admin/list"className={({isActive})=>`flex items-center gap-3 py-3.5 px-4 
      md:px-8 ${isActive&&'bg-primary/10 border-r-4 border-primary'} `}>
        <h5 className=' lg:inline-block'>Blog List</h5>
     </NavLink>

     <NavLink to="/admin/commentslist"className={({isActive})=>`flex items-center gap-3 py-3.5 px-4 
      md:px-8 ${isActive&&'bg-primary/10 border-r-4 border-primary'} `}>
        <h5 className=' lg:inline-block'>Comments List</h5>
     </NavLink>
    </div>
