...
export const Sidebar = () => {
  return (
    <div className='flex flex-col border-r border-gray-500 h-screen w-48  pt-6'>
     <NavLink end={true}  to='/dashboard' className={({isActive})=>`flex items-center gap-3 py-3.5 px-4
     ...
     <NavLink to='/dashboard/addblogs' className={({isActive})=>`flex items-center gap-3 py-3.5 px-4
     ...
     <NavLink to='/dashboard/bloglist' className={({isActive})=>`flex items-center gap-3 py-3.5 px-4 
     md:px-8 ${isActive&&'bg-primary/10 border-r-4 border-primary'} `}>
      <img src={assets.list_icon} className=' min-w-4 w-5'/>
      <h5 className='hidden md:inline-block'>BlogList</h5>
     </NavLink>

      <NavLink to='/dashboard/comments' className={({isActive})=>`flex items-center gap-3 py-3.5 px-4 
      md:px-8 ${isActive&&'bg-primary/10 border-r-4 border-primary'} `}>
      <img src={assets.list_icon} className=' min-w-4 w-5'/>
