...
export const BlogCards = ({blog}) => {
  ...
  return (
    <div>
        ...
        <div onClick={()=>navigate(`/blog/get/${_id}`)} className='w-full h-full rounded-lg overflow-hidden shadow hover:scale-102 hover:shadow-primary/25 duration-300 cursor-pointer'>
